...
const Register = () => {
  ...
  const [selectedProviderRole, setSelectedProviderRole] = useState<"doctor" | "hospital" | "lab" | "pharmaceutical" | "ambulance" | undefined>(undefined);
  ...
  const handleProviderRoleSelect = (role: "doctor" | "hospital" | "lab" | "pharmaceutical" | "ambulance") => {
